const experience = [
    ...
    },
    {
      ...
      dateSort: new Date("2023-07-01"),
      description:
        "Wrote Python scripts to assist with data migration during the transition from Lawson to Workday. Focused on parsing and formatting CSV invoice data, reducing manual entry and supporting cleaner system handoffs.",
